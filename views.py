...
def discharge_patient_view(request,pk):
    patient=models.Patient.objects.get(id=pk)
    days=(date.today()-patient.consultDate) #2 days, 0:00:00
    ...
    patientDict={
        ...
        'dateOfPregnancy':patient.dateOfPregnancy,
        'consultDate':patient.consultDate,
    ...
    if request.method == 'POST':
        ...
        pDD.dateOfPregnancy=patient.dateOfPregnancy
        pDD.consultDate=patient.consultDate
...
def download_pdf_view(request,pk):
    ...
    dict={
        ...
        'dateOfPregnancy':dischargeDetails[0].dateOfPregnancy,
        'consultDate':dischargeDetails[0].consultDate,
